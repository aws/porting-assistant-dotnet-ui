...
~\AppData\Local\Microsoft\dotnet\dotnet publish ..\csharp\PortingAssistant\PortingAssistant.Api\PortingAssistant.Api.csproj -c Release -f net6.0 -o netcore_build
~\AppData\Local\Microsoft\dotnet\dotnet publish ..\csharp\PortingAssistant\PortingAssistant.Telemetry\PortingAssistant.Telemetry.csproj -c Release -f net6.0 -o netcore_build 
